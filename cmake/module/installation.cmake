...
# Exporting targets
# -----------------------------------------------------------------------------
set(PACKAGE_TARGETS_FILENAME sup-epics-targets.cmake)
...
install(EXPORT sup-epics-targets FILE ${PACKAGE_TARGETS_FILENAME} NAMESPACE sup-epics:: DESTINATION ${INSTALL_CONFIGDIR})

# Generate the export targets for the build tree usage
export(TARGETS sup-epics sup-epics-di sup-epics-test NAMESPACE sup-epics:: FILE ${PACKAGE_TARGETS_FILE})
...
# -----------------------------------------------------------------------------
set(PACKAGE_VERSION_FILE ${BUILD_CONFIGDIR}/sup-epics-config-version.cmake)
...
# -----------------------------------------------------------------------------
set(PACKAGE_CONFIG_FILE ${BUILD_CONFIGDIR}/sup-epics-config.cmake)
